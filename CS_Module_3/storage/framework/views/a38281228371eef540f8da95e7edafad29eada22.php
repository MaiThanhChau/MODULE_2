                ...
                <div class="container">
                    <div class="slider slider--with-dots">
                        <div class="owl-carousel">
                            <a href="<?php echo e(route('shoplist.categories', 'tui-deo-cheo')); ?>">
                                <picture>
                                    <img src="<?php echo e(asset('storage/image/home-3.jpg')); ?>" alt=""
                                        style="width: 100%; height: 500px">
                                </picture>
                            </a>
                            <a href="<?php echo e(route('shoplist.categories', 'clutch')); ?>">
                                <picture>
                                    <img src="<?php echo e(asset('storage/image/home-2.jpg')); ?>" alt=""
                                        style="width: 100%; height: 500px">
                                </picture>
                            </a>
                            <a href="<?php echo e(route('shoplist.categories', 'tui-xach-nu')); ?>">
                                <picture>
                                    <img src="<?php echo e(asset('storage/image/home-1.jpg')); ?>" alt=""
                                        style="width: 100%; height: 500px">
                                </picture>
                            </a>
                        </div>
                    ...
                    <div class="block-products-carousel__slider slider slider--with-arrows">
                        <div class="owl-carousel">
                            ...
                            <div class="product-card product-card--layout--grid">
                                ...
                                <div class="product-card__image"><a href="<?php echo e(route('shop.product', $product->slug)); ?>"><img
                                            src="<?php echo e(asset('storage/'.$product->image)); ?>" alt=""></a></div>
                                <div class="product-card__info">
                                    <div class="product-card__category"><a href=""><?php echo e($product->categories->name); ?></a>
                                    </div>
                                    <div class="product-card__name"><a href="<?php echo e(route('shop.product', $product->slug)); ?>"><?php echo e($product->name); ?></a>
                                    </div>
                                    <div class="product-card__prices-list">
                                        <div class="product-card__price"><?php echo e(number_format($product->price)); ?><span
                                                class="woocommerce-Price-currencySymbol"> ₫</span></div>
                                    </div>
                                    <div class="product-card__buttons">
                                        <div class="product-card__buttons-list">
                                            <a class="btn btn-primary product-card__addtocart" type="button" onclick="addCart(<?php echo e($product->id); ?>)" href="javascript:">Thêm vào giỏ hàng
                                            </a>
                ...
                <div class="container">
                    ...
                    <?php $__currentLoopData = $latest_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $latest_product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="card category-card">
                            <a href="<?php echo e(route('shop.product', $latest_product->slug)); ?>">
                                <div class="category-card__image"><img
                                        src="<?php echo e(asset('storage/'.$latest_product->image)); ?>" alt=""></div>
                                <div class="category-card__name"><?php echo e($latest_product->name); ?></div>
                            </a>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
...
<?php echo $__env->make('layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\CS_Module_3\resources\views/website/index.blade.php ENDPATH**/ ?>