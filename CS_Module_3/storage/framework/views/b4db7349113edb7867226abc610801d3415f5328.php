            ...
            <div class="block">
                <div class="product container">
                    <div class="card product__info">
                            ...
                            <div class="product-gallery">
                                <div class="product-gallery__featured">
                                    <div class="owl-carousel" id="product-image"><a
                                            href="<?php echo e(url('/')); ?>/images/products/product1-1-big@2x.jpg" data-width="1000"
                                            data-height="1000" target="_blank"><img
                                                srcset="<?php echo e(url('/')); ?>/images/products/product1-1-big.jpg, <?php echo e(url('/')); ?>/images/products/product1-1-big@2x.jpg 2x"
                                                src="<?php echo e(url('/')); ?>/images/products/product1-1-big.jpg" alt=""> </a><a
                                            href="<?php echo e(url('/')); ?>/images/products/product1-2-big@2x.jpg" data-width="1000"
                                            data-height="1000" target="_blank"><img
                                                srcset="<?php echo e(url('/')); ?>/images/products/product1-2-big.jpg, <?php echo e(url('/')); ?>/images/products/product1-2-big@2x.jpg 2x"
                                                src="<?php echo e(url('/')); ?>/images/products/product1-2-big.jpg" alt=""> </a><a
                                            href="<?php echo e(url('/')); ?>/images/products/product1-3-big@2x.jpg" data-width="1000"
                                            data-height="1000" target="_blank"><img
                                                srcset="<?php echo e(url('/')); ?>/images/products/product1-3-big.jpg, <?php echo e(url('/')); ?>/images/products/product1-3-big@2x.jpg 2x"
                                                src="<?php echo e(url('/')); ?>/images/products/product1-3-big.jpg" alt=""></a></div>
                                </div>
                                <div class="product-gallery__carousel">
                                    <div class="owl-carousel" id="product-carousel"><a href=""
                                            class="product-gallery__carousel-item"><img
                                                ...
                                                srcset="<?php echo e(url('/')); ?>/images/products/product1-1-big.jpg, <?php echo e(url('/')); ?>/images/products/product1-1-big@2x.jpg 2x"
                                                src="<?php echo e(url('/')); ?>/images/products/product1-1-big.jpg" alt=""> </a><a href=""
                                            class="product-gallery__carousel-item"><img
                                                class="product-gallery__carousel-image"
                                                srcset="<?php echo e(url('/')); ?>/images/products/product1-2-big.jpg, <?php echo e(url('/')); ?>/images/products/product1-2-big@2x.jpg 2x"
                                                src="<?php echo e(url('/')); ?>/images/products/product1-2-big.jpg" alt=""> </a><a href=""
                                            class="product-gallery__carousel-item"><img
                                                class="product-gallery__carousel-image"
                                                srcset="<?php echo e(url('/')); ?>/images/products/product1-3-big.jpg, <?php echo e(url('/')); ?>/images/products/product1-3-big@2x.jpg 2x"
                                                src="<?php echo e(url('/')); ?>/images/products/product1-3-big.jpg" alt=""></a></div>
                        ...
                        <div class="product__details">
                            <div class="product__categories-sku">
                                <div class="product__categories"><a href="">Bedroom</a>, <a href="">Chandeliers</a>
                                </div>
                                    ...
                                    <div class="rating">
                                        <div class="rating__body"><svg class="rating__star rating__star--active"
                                                ...
                                                <g class="rating__fill">
                                                    <use xlink:href="<?php echo e(url('/')); ?>/images/sprite.svg#star-normal"></use>
                                                </g>
                                                <g class="rating__stroke">
                                                    <use xlink:href="<?php echo e(url('/')); ?>/images/sprite.svg#star-normal-stroke">
                                                    </use>
                                                </g>
                            ...
                            <form class="product__options">
                                <div class="form-group product__option"><label
                                    ...
                                    <div class="radio-color">
                                        <div class="radio-color__list"><label
                                                class="radio-color__item radio-color__item--white"
                                                ...
                                                style="color: #5398ff;"><input type="radio" name="color"
                                                    disabled="disabled"> <span></span></label></div>
                                    </div>
                                </div>
                                <div class="form-group"><label class="product__option-label">Material</label>
                                ...
                                <div class="form-group"><label class="product__option-label">Quantity</label>
                                    <div class="product__actions">
                                        ...
                                        <div class="product__actions-item"><button class="btn btn-primary btn-lg">Add to
                                                cart</button></div>
                                        <div class="product__actions-item"><button type="button"
                                                class="btn btn-secondary btn-svg-icon btn-lg product__wishlist"><svg
                                                    class="product-card__action-icon" width="16px" height="16px">
                                                    <use xlink:href="<?php echo e(url('/')); ?>/images/sprite.svg#wishlist-16"></use>
                                                </svg></button></div>
                                        <div class="product__actions-item"><button type="button"
                                                class="btn btn-secondary btn-svg-icon btn-lg product__compare"><svg
                                                    class="product-card__action-icon" width="16px" height="16px">
                            ...
                            <div class="product__tags">Tags: <a href="">Bedroom</a>, <a href="">Chandelier</a>, <a
                                    href="">Lamp</a></div>
                    ...
                    <div class="card product__tabs tabs tabs--product">
                        <div class="tabs__list"><a href="#tab-description"
                                class="tabs__tab tabs__tab--active">Description</a> <a href="#tab-specification"
                                class="tabs__tab">Specification</a> <a href="#tab-reviews" class="tabs__tab">Reviews</a>
                        </div>
                        ...
                        <div class="owl-carousel">
                            <div class="product-card product-card--layout--grid">
                                <div class="product-card__actions">
                                    <div class="product-card__actions-list"><button
                                            class="btn btn-light btn-svg-icon btn-sm" type="button"><svg width="16px"
                                                height="16px">
                                                <use xlink:href="<?php echo e(url('/')); ?>/images/sprite.svg#quickview-16"></use>
                                ...
                                <div class="product-card__image"><a href="product.html"><img
                                            ...
                                            src="<?php echo e(url('/')); ?>/images/products/product1-1.jpg" alt=""></a></div>
                                <div class="product-card__info">
                                    <div class="product-card__category"><a href="">Chandeliers</a></div>
                                    <div class="product-card__name"><a href="product.html">Aluminum
                                            Chandelier</a></div>
                            ...
                            <div class="product-card product-card--layout--grid">
                                ...
                                <div class="product-card__image"><a href="product.html"><img
                                            ...
                                            src="<?php echo e(url('/')); ?>/images/products/product2-1.jpg" alt=""></a></div>
                                <div class="product-card__info">
                                    <div class="product-card__category"><a href="">Lamps</a></div>
                                    <div class="product-card__name"><a href="product.html">Bedside Lamp</a>
                                    </div>
                                    <div class="product-card__rating">
                            ...
                            <div class="product-card product-card--layout--grid">
                                ...
                                <div class="product-card__image"><a href="product.html"><img
                                            ...
                                            src="<?php echo e(url('/')); ?>/images/products/product3-1.jpg" alt=""></a></div>
                                <div class="product-card__info">
                                    <div class="product-card__category"><a href="">Cabinets</a></div>
                                    <div class="product-card__name"><a href="product.html">Wooden Closet</a>
                                    </div>
                                    <div class="product-card__rating">
                            ...
                            <div class="product-card product-card--layout--grid">
                                ...
                                <div class="product-card__image"><a href="product.html"><img
                                            ...
                                            src="<?php echo e(url('/')); ?>/images/products/product4-1.jpg" alt=""></a></div>
                                <div class="product-card__info">
                                    <div class="product-card__category"><a href="">Wooden Chairs</a></div>
                                    <div class="product-card__name"><a href="product.html">Monero Chair</a>
                                    </div>
                                    <div class="product-card__rating">
                                        <div class="product-card__rating-title">Reviews (0)</div>
                                        <div class="product-card__rating-stars">
                                            <div class="rating">
                                                <div class="rating__body"><svg class="rating__star" width="13px"
                                                        height="12px">
                                                        <g class="rating__fill">
                                                            <use xlink:href="<?php echo e(url('/')); ?>/images/sprite.svg#star-normal">
                                                            </use>
                            ...
                            <div class="product-card product-card--layout--grid">
                                ...
                                <div class="product-card__image"><a href="product.html"><img
                                            ...
                                            src="<?php echo e(url('/')); ?>/images/products/product5-1.jpg" alt=""></a></div>
                                <div class="product-card__info">
                                    <div class="product-card__category"><a href="">Shoe Racks</a></div>
                                    <div class="product-card__name"><a href="product.html">Shoe Cabinet</a>
                                    </div>
                                    <div class="product-card__rating">
                            ...
                            <div class="product-card product-card--layout--grid">
                                ...
                                <div class="product-card__image"><a href="product.html"><img
                                            ...
                                            src="<?php echo e(url('/')); ?>/images/products/product6-1.jpg" alt=""></a></div>
                                <div class="product-card__info">
                                    <div class="product-card__category"><a href="">Armchairs</a></div>
                                    <div class="product-card__name"><a href="product.html">Stylish
                                            Armchair</a></div>
                                    <div class="product-card__rating">
                            ...
                            <div class="product-card product-card--layout--grid">
                                ...
                                <div class="product-card__image"><a href="product.html"><img
                                            ...
                                            src="<?php echo e(url('/')); ?>/images/products/product7-1.jpg" alt=""></a></div>
                                <div class="product-card__info">
                                    <div class="product-card__category"><a href="">Fabric Sofas</a></div>
                                    <div class="product-card__name"><a href="product.html">White Sofa</a>
                                    </div>
                                    <div class="product-card__rating">
                            ...
                            <div class="product-card product-card--layout--grid">
                                ...
                                <div class="product-card__image"><a href="product.html"><img
                                            ...
                                            src="<?php echo e(url('/')); ?>/images/products/product8-1.jpg" alt=""></a></div>
                                <div class="product-card__info">
                                    <div class="product-card__category"><a href="">Armchairs</a></div>
                                    <div class="product-card__name"><a href="product.html">Black Leather
                                            Chair</a></div>
                                    <div class="product-card__rating">
                                        <div class="product-card__rating-title">Reviews (0)</div>
                                        <div class="product-card__rating-stars">
                            ...
                            <div class="product-card product-card--layout--grid">
                                ...
                                <div class="product-card__image"><a href="product.html"><img
                                            ...
                                            src="<?php echo e(url('/')); ?>/images/products/product9-1.jpg" alt=""></a></div>
                                <div class="product-card__info">
                                    <div class="product-card__category"><a href="">Decor</a></div>
                                    <div class="product-card__name"><a href="product.html">Magic Lamp</a>
                                    </div>
                                    <div class="product-card__rating">
                                        <div class="product-card__rating-title">Reviews (0)</div>
                                        <div class="product-card__rating-stars">
                            ...
                            <div class="product-card product-card--layout--grid">
                                ...
                                <div class="product-card__image"><a href="product.html"><img
                                            ...
                                            src="<?php echo e(url('/')); ?>/images/products/product10-1.jpg" alt=""></a></div>
                                <div class="product-card__info">
                                    <div class="product-card__category"><a href="">Beds</a></div>
                                    <div class="product-card__name"><a href="product.html">Meridian Day</a>
                                    </div>
                                    <div class="product-card__rating">
                            ...
                            <div class="product-card product-card--layout--grid">
                                ...
                                <div class="product-card__image"><a href="product.html"><img
                                            ...
                                            src="<?php echo e(url('/')); ?>/images/products/product11-1.jpg" alt=""></a></div>
                                <div class="product-card__info">
                                    <div class="product-card__category"><a href="">Bookshelves</a></div>
                                    <div class="product-card__name"><a href="product.html">4-Section
                                            Bookcase</a></div>
                                    <div class="product-card__rating">
                            ...
                            <div class="product-card product-card--layout--grid">
                                ...
                                <div class="product-card__image"><a href="product.html"><img
                                            ...
                                            src="<?php echo e(url('/')); ?>/images/products/product12-1.jpg" alt=""></a></div>
                                <div class="product-card__info">
                                    <div class="product-card__category"><a href="">Stools</a></div>
                                    <div class="product-card__name"><a href="product.html">Round Stool</a>
                                    </div>
                                    <div class="product-card__rating">
                                        <div class="product-card__rating-title">Reviews (8)</div>
                                        <div class="product-card__rating-stars">
                            ...
                            <div class="product-card product-card--layout--grid">
                                ...
                                <div class="product-card__image"><a href="product.html"><img
                                            ...
                                            src="<?php echo e(url('/')); ?>/images/products/product13-1.jpg" alt=""></a></div>
                                <div class="product-card__info">
                                    <div class="product-card__category"><a href="">Armchairs</a></div>
                                    <div class="product-card__name"><a href="product.html">Fabric Chair</a>
                                    </div>
                                    <div class="product-card__rating">
                            ...
                            <div class="product-card product-card--layout--grid">
                                ...
                                <div class="product-card__image"><a href="product.html"><img
                                            ...
                                            src="<?php echo e(url('/')); ?>/images/products/product14-1.jpg" alt=""></a></div>
                                <div class="product-card__info">
                                    <div class="product-card__category"><a href="">Stools</a></div>
                                    <div class="product-card__name"><a href="product.html">Wooden Stool</a>
                                    </div>
                                    <div class="product-card__rating">
                            ...
                            <div class="product-card product-card--layout--grid">
                                ...
                                <div class="product-card__image"><a href="product.html"><img
                                            ...
                                            src="<?php echo e(url('/')); ?>/images/products/product15-1.jpg" alt=""></a></div>
                                <div class="product-card__info">
                                    <div class="product-card__category"><a href="">Decor</a></div>
                                    <div class="product-card__name"><a href="product.html">Treasure
                                            Chest</a></div>
                                    <div class="product-card__rating">
                            ...
                            <div class="product-card product-card--layout--grid">
                                ...
                                <div class="product-card__image"><a href="product.html"><img
                                            ...
                                            src="<?php echo e(url('/')); ?>/images/products/product16-1.jpg" alt=""></a></div>
                                <div class="product-card__info">
                                    <div class="product-card__category"><a href="">Wooden Chair</a></div>
                                    <div class="product-card__name"><a href="product.html">Luxurious
                                            Chair</a></div>
                                    <div class="product-card__rating">
                                        <div class="product-card__rating-title">Reviews (0)</div>
                                        <div class="product-card__rating-stars">
...
<?php echo $__env->make('layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CodeGym\Module_3\Laravel\CS_Module_3\resources\views/website/shop/product.blade.php ENDPATH**/ ?>