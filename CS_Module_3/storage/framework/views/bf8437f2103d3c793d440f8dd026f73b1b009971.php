                        ...
                        <div class="row justify-content-between">
                            <div class="col-12 col-lg-4 col-sm-6 footer__aboutus">
                                <div class="footer-aboutus">
                                    ...
                                    <div class="footer-aboutus__text">Lorem ipsum dolor sit amet,
                                    ...
                                    <ul class="footer-aboutus__contacts">
                                        <li class="footer-aboutus__contacts-item"><a href="">715 Park Ave,
                                                NY 10021 USA</a></li>
                                        <li class="footer-aboutus__contacts-item"><a href="">meblya@example.com</a></li>
                                        <li class="footer-aboutus__contacts-item"><a href="">+1 754
                                                000-00-00</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-12 col-lg-2 col-sm-6 col-md-3">
                                <div class="footer-links" data-collapse data-collapse-open-class="footer-links--open"
                                    data-collapse-item>
                                    ...
                                    <div class="footer-links__content" data-collapse-content>
                                        <ul class="footer-links__list">
                                            ...
                                            <li class="footer-links__item"><a href=""
                                                    class="footer-links__link">Delivery Information</a></li>
                            ...
                            <div class="col-12 col-lg-2 col-sm-6 col-md-3">
                                <div class="footer-links" data-collapse data-collapse-open-class="footer-links--open"
                                    ...
                                    <div class="footer-links__content" data-collapse-content>
                                        <ul class="footer-links__list">
                                            <li class="footer-links__item"><a href="" class="footer-links__link">My
                                                    Account</a></li>
                            ...
                            <div class="col-12 col-lg-4 footer__followus">
                                <div class="footer-followus">
                                    ...
                                    <div class="footer-followus__text">Praesent pellentesque volutpat ex,
                                        vitae auctor lorem pulvinar mollis felis at lacinia.</div>
                                    <form class="footer-followus__subscribe-form"><input type="email"
                                            class="form-control form-control--footer" placeholder="Email address">
...
</footer><!-- site__footer / end --><?php /**PATH D:\CodeGym\Module_3\Laravel\CS_Module_3\resources\views/layout/includes/footer.blade.php ENDPATH**/ ?>