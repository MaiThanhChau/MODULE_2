                                        ...
                                        <tbody class="cart__body">
                                            <tr>
                                                <td class="cart__column cart__column--image"><a href="product.html"><img
                                                            ...
                                                            src="images/products/product1-1.jpg" alt=""></a>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="cart__column cart__column--image"><a href="product.html"><img
                                                            ...
                                                            src="images/products/product3-1.jpg" alt=""></a>
                                                </td>
                                                <td class="cart__column cart__column--info">
                                            ...
                                            <tr>
                                                <td class="cart__column cart__column--image"><a href="product.html"><img
                                                            ...
                                                            src="images/products/product4-1.jpg" alt=""></a>
                                                </td>
                                                <td class="cart__column cart__column--info">
...
<?php echo $__env->make('layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CodeGym\Module_3\Laravel\CS_Module_3\resources\views/website/cart.blade.php ENDPATH**/ ?>