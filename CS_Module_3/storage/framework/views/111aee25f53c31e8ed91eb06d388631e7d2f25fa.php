                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <form action="<?php echo e(route('products.filter')); ?>" method="post">
                            ...
                            (<?php echo e(count($products)); ?> <span>Sản phẩm</span>)
                        </form>
                    </div>
                    <div class="card-body">
...
<?php echo $__env->make('layout.admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\CS_Module_3\resources\views/admin/products/listfilter.blade.php ENDPATH**/ ?>