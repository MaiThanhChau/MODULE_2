...
$objLinkedList = new LinkList();
$objLinkedList->insertLast( 'A Hà' );
$objLinkedList->insertLast( 'Hoàn' );
$objLinkedList->insertLast( 'Châu' );
$objLinkedList->insertLast( 'Thảo' );
$objLinkedList->insertLast( 'Ngọc Anh' );
